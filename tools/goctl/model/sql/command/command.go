...
import (
	...
	"github.com/Peakchen/go-zero/core/stores/postgres"
	"github.com/Peakchen/go-zero/core/stores/sqlx"
	"github.com/Peakchen/go-zero/tools/goctl/config"
	"github.com/Peakchen/go-zero/tools/goctl/model/sql/command/migrationnotes"
	"github.com/Peakchen/go-zero/tools/goctl/model/sql/gen"
	"github.com/Peakchen/go-zero/tools/goctl/model/sql/model"
	"github.com/Peakchen/go-zero/tools/goctl/model/sql/util"
	file "github.com/Peakchen/go-zero/tools/goctl/util"
