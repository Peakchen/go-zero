module github.com/Peakchen/peakchen-go-zero/tools/goctl
...
require (
	...
	github.com/Peakchen/antlr v0.0.1
	github.com/Peakchen/ddl-parser v1.0.4
	github.com/Peakchen/peakchen-go-zero v1.5.2
