...
import (
	...
	"github.com/Peakchen/go-zero/tools/goctl/api"
	"github.com/Peakchen/go-zero/tools/goctl/bug"
	"github.com/Peakchen/go-zero/tools/goctl/docker"
	"github.com/Peakchen/go-zero/tools/goctl/env"
	"github.com/Peakchen/go-zero/tools/goctl/gateway"
	"github.com/Peakchen/go-zero/tools/goctl/internal/cobrax"
	"github.com/Peakchen/go-zero/tools/goctl/internal/version"
	"github.com/Peakchen/go-zero/tools/goctl/kube"
	"github.com/Peakchen/go-zero/tools/goctl/migrate"
	"github.com/Peakchen/go-zero/tools/goctl/model"
	"github.com/Peakchen/go-zero/tools/goctl/quickstart"
	"github.com/Peakchen/go-zero/tools/goctl/rpc"
	"github.com/Peakchen/go-zero/tools/goctl/tpl"
	"github.com/Peakchen/go-zero/tools/goctl/upgrade"
)
